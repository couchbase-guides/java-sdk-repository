...
This guide walks you through the process of using the Couchbase SDK repository abstraction to store a Customer document in Couchbase.
:imagesdir: images

== What you'll build

You will store a `Customer` link:/understanding/POJO[POJOs] in a Couchbase database using a repository abstraction.
